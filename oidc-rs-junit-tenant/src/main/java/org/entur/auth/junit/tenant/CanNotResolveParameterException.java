 ...
 *
 * <p>This runtime exception is used to indicate that a parameter injection is not supported or that
 * the resolution of the parameter failed during the execution of tests.
 */
