...
@TestPropertySource(
        properties = {
            "entur.auth.tenants.environment=dev",
...
@DirtiesContext
class DefaultConfigurationDevEnvironmentTest {
    ...
    void testTenantHasBeenLoaded() {
        assertInstanceOf(IssuerAuthenticationManagerResolver.class, authenticationManagerResolver);
        ...
        assertTrue(issuers.contains("https://internal.dev.entur.org/"));
        assertTrue(issuers.contains("https://partner.dev.entur.org/"));
        assertTrue(issuers.contains("https://traveller.dev.entur.org/"));
        assertTrue(issuers.contains("https://person.dev.entur.org/"));
    }
}
