...
@TestPropertySource(properties = {"entur.auth.cors.mode=api", "entur.auth.cors.hosts=http://known.host"})
...
class CorsAPIHostTest {
    ...
    private final List<String> hosts = List.of("https://petstore.swagger.io", "https://test-entur.devportal.apigee.io", "https://developer.entur.org", "http://known.host");
    @Autowired
